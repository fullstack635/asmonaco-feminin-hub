...
This form was submitted through the AS Monaco Football Féminin website.
  ...
  const sponsorContent = {
    ...
    en: {
      ...
      description: "Hello, how are you? For this section, in order to complete the sponsor interest form, it needs to redirect to the Google Form you previously shared:'  https://docs.google.com/forms/u/0/d/e/1FAIpQLSfQ2d6UgaMYcbuFdt-9MqE5O0sh9f-4LZeyjEmXaoeVYXaDyA/viewform?pli=1  ' To create or manage this form, I will need access to the Google account associated with this email:bobby@asmonacofeminin.com. Please share the necessary login credentials (password and verification code) to proceed. As a reminder, Workana policy prohibits sharing direct contact details like email or phone numbers via workana chat. Kindly let me know your preferred contact method (email, phone, or Telegram) to my email(stevenlai19950530@gmail.com) or telegram(@Stevenlai01530), so I can follow up securely outside the platform if needed. Also, please share the links to your social media accounts (Facebook, Instagram, Twitter) for the 'Follow Us' section in the footer.",
