          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {currentContent.sections.map((section, index) => (
              ...
              >
                ...
                {/* Header Area with Monaco Brand Colors */}
                <div className="relative w-full h-[220px] bg-monaco-red flex items-center justify-center overflow-hidden">
                  {/* Background Pattern */}
                  <div className="absolute inset-0 opacity-10">
                    <div className="absolute top-4 right-4 w-16 h-16 border border-monaco-yellow rounded-full"></div>
                    <div className="absolute bottom-4 left-4 w-12 h-12 border border-monaco-yellow rounded-lg rotate-45"></div>
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 border border-monaco-yellow rounded-full"></div>
                  </div>
                  
                  {/* Content Area - Centered Title */}
                  <div className="relative z-10 text-center">
                    ...
                    <div className="w-12 h-0.5 bg-monaco-yellow mx-auto rounded-full group-hover:w-16 transition-all duration-300"></div>
                  </div>
